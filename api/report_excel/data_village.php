...
try {
   ...
   if($_SERVER['REQUEST_METHOD'] == "POST" ){
        ...
        if ($data->id_loc !== null && $data->id_year !== null && $data->page) {

            $year= $data->id_year;
           
            $sql = $conn->query("SELECT t4.village as vil, t4.address as lo, t4.latitude as lat, t4.longitude as lng, t4.detail as detail, t1.question, SUM(t2.score=1) as A, SUM(t2.score=2) as B, SUM(t2.score=3) as C, SUM(t2.score=4) as D , SUM( t3.gender =1 ) AS gender1,
            SUM( t3.gender =2 ) AS gender2,SUM(t3.age = 1) AS age1,SUM(t3.age = 2) AS age2,SUM(t3.age = 3) AS age3,SUM(t3.age = 4) AS age4,SUM(t3.age =5) AS age5,
            ...
            FROM tb_question t1, tb_answer t2, tb_person  t3,  location_detail t4
            WHERE t1.id_question = t2.id_question
            AND t3.address = $data->id_loc
            AND t3.id_year = $data->id_year
            AND t4.id = $data->id_loc
            AND t3.id_person = t2.id_person
            AND t1.id_question = $data->page
