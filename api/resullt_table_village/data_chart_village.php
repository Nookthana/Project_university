...
try {
   ...
   if($_SERVER['REQUEST_METHOD'] == "POST" ){
        ...
        if ($data->id_loc !== null && $data->id_year !== null && $data->page) {
            ...
            $sql = $conn->query("SELECT t1.question, SUM(t2.score=1) as A, SUM(t2.score=2) as B, SUM(t2.score=3) as C, SUM(t2.score=4) as D , SUM( t3.gender =1 ) AS gender1,
            ...
            FROM tb_question t1, tb_answer t2, tb_person  t3 
